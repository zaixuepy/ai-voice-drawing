...
- ✅ 3619 条用户评论/笔记情感分析
- ✅ 词云可视化 + LDA 主题建模 + 舆情分析报告

**开发线：**
- ✅ 14 文件提示词体系：base / diagram-types / drawing-modes / thinker 模块化组装
- ✅ 前端自动布局引擎（layoutEngine.js 径向树算法），根除节点箭头重叠
- ✅ schemaValidator：5 种 action 校验 + 自动修复
- ✅ 人格系统 "小画"：40+ 消息变体 × 全触点覆盖
- ✅ 三级决策框架：直接画 / 一轮 / 至多两轮
- ✅ System prompt 精简 32%（11KB→7.3KB），max_tokens 提升至 8192
- ✅ Promise 后台运行，MainProcess 不被 DeepContent 阻塞

详见 [6月12日进度总结](docs/06-progress/2026-06-12-进度总结.md) | [6月13日进度总结](docs/06-progress/2026-06-13-进度总结.md)
